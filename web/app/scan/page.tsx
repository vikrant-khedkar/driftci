  ...
  return (
    <main className="mx-auto max-w-5xl px-8 py-16">
      <header className="mb-16">
        <a href="/" className="inline-flex items-baseline gap-3 hover:opacity-80">
        ...
        <p className="mt-3 max-w-xl text-base text-[var(--ink-soft)]">
          Point it at any Make app or n8n node, give it your OpenAPI spec, see the drift.
        </p>
      </header>
  ...
  return (
    <div className="flex h-full min-h-[360px] flex-col justify-center">
      ...
      <ol className="mt-5 space-y-4 text-[var(--ink-soft)]">
        <Step n={1}>
          Point drift/ci at a Make app, n8n node, or GitHub repo where your integration lives.
        </Step>
        <Step n={2}>
